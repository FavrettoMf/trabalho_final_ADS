...
<body>
    <div class="container">
        <div class="header">
            ...
            <h2>Recibo de Serviço</h2>
            <p>Data: {{ \Carbon\Carbon::parse($servicos['created_at'])->format('d/m/Y') }}</p>
        </div>

        <div class="details">
            <div class="section-title">Detalhes do Cliente</div>
            <table class="table">
                <tr>
                    <th>Campo</th>
                    <th>Detalhe</th>
                ...
                <tr>
                    <td>Nome</td>
                    <td>{{ $servicos->veiculos->clientes->nome ?? 'Não encontrado' }}</td>
                </tr>
                <tr>
                    <td>Email</td>
                    <td>{{ $servicos->veiculos->clientes->email ?? 'Não encontrado' }}</td>
                </tr>
                <tr>
                    <td>Telefone</td>
                    <td>{{ $servicos->veiculos->clientes->telefone ?? 'Não encontrado' }}</td>
                </tr>
                <tr>
                    <td>CPF</td>
                    <td>{{ $servicos->veiculos->clientes->cpf ?? 'Não encontrado' }}</td>
                </tr>
            </table>
            ...
            <table class="table">
                ...
                <tr>
                    <td>Defeito e Observações</td>
                    <td class="defeito-content">{!! nl2br(e($servicos['defeito'])) !!}</td>
                </tr>
            </table>
        </div>
