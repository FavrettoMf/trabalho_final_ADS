...
<body>
    <div class="container">
        ...
        <div class="details">
            <div class="section-title">Detalhes do Cliente e Veículo</div>
            <p><span class="label">Cliente:</span><span class="value">{{ $servicos->veiculos->clientes->nome ?? 'Cliente não encontrado' }}</span></p>
            <p><span class="label">Placa:</span><span class="value">{{ $servicos->veiculos->placa }}</span></p>
            <p><span class="label">Modelo:</span><span class="value">{{ $servicos->veiculos->modelo }}</span></p>

            <div class="section-title">Detalhes do Serviço</div>
            <p><span class="label">Tipo de Serviço:</span><span class="value">{{ $servicos->tipo_servicos->tipo }}</span></p>
            <p><span class="label">Tempo de Serviço:</span><span class="value">{{ $servicos->tipo_servicos['tempo_estimado'] }} Horas</span></p>
            <p><span class="label">Custo:</span><span class="value">R$ {{ number_format($servicos->tipo_servicos['custo_medio'], 2, ',', '.') }}</span></p>
            <p><span class="label">Status:</span><span class="value">{{ $servicos->status }}</span></p>
            <p>
    <span class="defeito-label">Defeito e observações adicionais:</span>
    <div class="defeito-content">{!! nl2br(e($servicos['defeito'])) !!}</div>
</p>
        ...
        <div class="contact-info">
            ...
            <p>Email: <a href="mailto:196187@upf.br">196187@upf.br</a></p>
            <p>Endereço: Rua Doutor Roberto Tasca, 96 - Passo Fundo, RS</p>
        </div>
