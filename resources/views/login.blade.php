...
<body>
    <div class="background-image">
        <!-- Formulário de login dentro de um container -->
        <div class="container">
            <!-- Logo -->
            ...
            <!-- Título -->
            <h1 class="text-center text-2xl font-bold mb-6">Bem-vindo ao seu gerenciamento!</h1>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4" id="loginForm">
                ...
                <div class="flex items-center justify-between">
                    <div class="text-sm">
                        <a href="{{ route('register') }}" class="text-indigo-600 hover:text-indigo-900">{{ __('Register') }}</a>
                    </div>
                </div>
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', function(event) {
            ...
            // Verifique se a senha atende aos critérios desejados (exemplo: ao menos 8 caracteres)
